...
import { tags } from '@data/movementsData';
...
import { newUserMovement, deleteUserMovement, updateUserMovement } from '@api/MovementsApi';
...
const ListItem = ({ id, date, description, amount, movementType, tag, onEdit }) => {
    ...
    return (
        <div className="border p-3" style={{ cursor: 'pointer' }} onClick={toggleDetails} key={id}>
            <div className="d-flex justify-content-between align-items-center">
                <span className="fw-bold">{description}</span>
                <div className="d-flex align-items-center">
                    <span className={`d-none d-md-block`} style={{ color: colors[movementType][1] }}>
                ...
                <div className="m-2">
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-1">
                            ...
                            <div><strong>Tipo:</strong> {typeTranslation[movementType]}</div>
                            <div><strong>Etiqueta:</strong> {tag ? tag.name : 'No tiene una etiqueta'}</div>
                        </div>
...
const Movements = ({ isOpen, onClose, title, id, date, amount, description, movementType, tagId }) => {
...
const ManageMovements = () => {
    ...
    const handleOpen = (movementData) => {
        ...
        setMovementProps(
            movementData?.id
                ? movementData
                : { id: null, date: "", description: "", amount: "", movementType: "income", tagId: null }
        );
        setIsOpen(true);
    };
        ...
        <>
            ...
            <div className="container-fluid rounded px-2 py-3 bg-body-tertiary">
                <div className="card">
                    ...
                    <div className="card-body p-0" style={{ maxHeight: "800px", overflowY: "auto" }}>
