        ...
        <div>
            ...
            <main>
                <div className="container d-flex flex-column justify-content-center align-items-center p-3">
                    ...
                    <div className="bg-body-tertiary card p-4" style={{ maxwidth: '400px' }}>
                            ...
                            <form>
                                <div className="mb-3">
                                    ...
                                    <input type="email" className="form-control" id="email" placeholder="Ingresa tu correo o usuario" />
                                </div>
                                <div className="mb-3 position-relative">
                                    ...
                                    <button
                                        ...
                                        style={{ top: 'calc(50% - 5px)', right: '10px', border: 'none', background: 'transparent' }}
                                        onClick={togglePasswordVisibility}
                                    >
                                        <i className={`bi ${passwordVisible ? 'bi-eye-slash' : 'bi-eye'} fs-5 text-success`}></i>
                                    </button>
                                </div>
                                ...
                                <button onClick={handleHomeRedirect} type="submit" className="btn btn-success w-100 mb-2">Iniciar sesión</button>
